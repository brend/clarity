        ...
        for (const rowIndex of dirtyIndexes) {
            ...
            const didSave =
                rowIndex < originalRowCount
                    ? await props.onUpdateActiveObjectDataRow(rowIndex, [
                          ...rowValues,
                      ])
    ...
    <section class="sheet-pane" @keydown.capture="handleSheetKeydown">
        <div class="sheet-tabs">
            ...
            >
                <button
                    class="sheet-tab"
                    @click="props.onActivateWorkspaceTab(tab.id)"
                >
                    {{ tab.title }}
                </button>
                <button
            ...
            <div
                class="sheet-tab-wrap"
                :class="{ active: props.isSearchTabActive }"
            >
                <button
        ...
        <section v-if="props.isQueryTabActive" class="query-sheet-pane">
            ...
            >
                <div class="ai-suggestion-body">
                    <p
                        v-if="props.aiSuggestionLoading"
                        class="ai-suggestion-text"
                    >
                        Generating suggestion...
                    </p>
                    <p
                        v-else-if="props.aiSuggestionError"
                        class="ai-suggestion-text"
                    >
                        {{ props.aiSuggestionError }}
                    </p>
                    <template v-else-if="hasAiSuggestion">
                        ...
                        <p
                            v-if="props.aiSuggestionRationale"
                ...
                <div class="ai-suggestion-actions">
                    <button
                        class="btn"
                        :disabled="
                            !hasAiSuggestion || props.aiSuggestionLoading
                        "
        ...
        <section v-else-if="props.activeDdlTab" class="ddl-pane">
            ...
            >
                ...
                <template v-else>
                    ...
                    <p
                        v-if="
                            props.activeObjectDetailResult.rowsAffected !== null
                        "
                        class="muted"
                    >
                        Rows affected:
                    ...
                    <p
                        v-else-if="
                            !props.activeObjectDetailResult.columns.length
                        "
                        class="muted"
                    >
                        No rows returned.
                    ...
                    <template v-else>
                        <p
                            ...
                            class="muted object-detail-hint"
                        >
                            Cells are editable. Use Add Row, Revert, or Commit
                            below.
                        </p>
                        <p
                            v-else-if="isDataDetailTab"
                            class="muted object-detail-hint"
                        >
        ...
        <section v-else-if="props.isSearchTabActive" class="source-search-pane">
            <div class="source-search-toolbar">
                ...
                <label class="search-scope-toggle">
                    <input
                        v-model="schemaSearchIncludeObjectNames"
                        type="checkbox"
                    />
                    Object names
                </label>
                <label class="search-scope-toggle">
                    <input
                        v-model="schemaSearchIncludeSource"
                        type="checkbox"
                    />
                    Source
                </label>
                        ...
                        >
                            <td>
                                <button
                                    ...
                                    @click="
                                        props.onOpenSchemaSearchResult(match)
                                    "
                                >
